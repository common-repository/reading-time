...
function reading_time_options()
{
	...
	if (
		isset($_POST['reading_time_text']) or isset($_POST['reading_time_speed'])
...
?>
	...
	<div class="wrap">
		...
		<form name="form1" method="post" action="">
			...
			<table>
				<tr>
					<td valign="top"><?php _e("Text", 'menu-test'); ?>:</td>
				...
				<tr>
					<td valign="top"><?php _e("Speed", 'menu-test'); ?>:</td>
				...
				<tr>
					<td valign="top"><?php _e("Progress bar color", 'menu-test'); ?>:</td>
				...
				<tr>
					<td valign="top"><?php _e("Position", 'menu-test'); ?>:</td>
				...
				<tr>
					<td valign="top"><?php _e("Progress bar display", 'menu-test'); ?>:</td>
				...
				<tr>
					<td valign="top"><?php _e("Show minutes instead of seconds", 'menu-test'); ?>:</td>
